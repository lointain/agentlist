...
--> statement-breakpoint
CREATE UNIQUE INDEX "ux_permissions_name" ON "permissions" USING btree ("name");--> statement-breakpoint
...
CREATE UNIQUE INDEX "ux_roles_name" ON "roles" USING btree ("name");--> statement-breakpoint
